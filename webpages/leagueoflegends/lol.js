...
if(a==0){var a = 'euw'}
if(b != ""){window.location = ("https://" + a + ".op.gg/summoner/userName=" + b +""); return;}
...
function przekierowanie2(){
  ...
  var b = document.getElementById('nick2').value;
if(a==0){var a = 'euw'}
if(b != ""){window.location = ("https://wol.gg/stats/" + a +"/" + b +"/"); return;}
alert('Write your nickname clown!');
}
function przekierowanie3(){
  ...
  var b = document.getElementById('nick2').value;
if(a==0){var a = 'euw'}
if(b != ""){window.location = ("https://www.masterypoints.com/player/" + b + "/" + a + ""); return;}
alert('Write your nickname clown!');
}
function przekierowanie4(){
  ...
  var b = document.getElementById('nick2').value;
if(a==0){var a = 'euw'}
if(b != ""){window.location = ("http://www.lolskill.net/summoner/" + a + "/"+ b + ""); return;}
alert('Write your nickname clown!');
}
